...
const Sidenav = forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>((props, ref) => {

    
    return (
        <>
             <aside ref={ref} {...props}  className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
                <div className="sidenav-header">
                <i className="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
                <a className="navbar-brand m-0" target="_blank">
                    <img src="./public/assets/img/logo-ct-dark.png" className="navbar-brand-img h-100" alt="main_logo"/>
                ...
                <ul className="navbar-nav">
                    ...
                    <a className="nav-link  active" href="../pages/tables.html">
                        ...
                        <span className="nav-link-text ms-1">Client</span>
                    </a>
                    </li>
                    <li className="nav-item">
                    <a className="nav-link  " href="../pages/billing.html">
                        ...
                        <span className="nav-link-text ms-1">Utilisateur</span>
                    </a>
                    </li>
                    ...
                    <a className="nav-link  " href="../pages/billing.html">
                        ...
                        <span className="nav-link-text ms-1">Decodeur</span>
                    </a>
                    </li>
